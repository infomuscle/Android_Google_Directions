    ...
    class MyTime extends TimerTask{
        ...
        public void run() {
            try {
                ...
                remoteViews.setTextViewText(R.id.textView_Temperatureappwidget_text, "온        도 : " + ServerSocketAcceptIOT.getDbhelper().returnTemperature() + "도");
                remoteViews.setTextViewText(R.id.textView_Humidityappwidget_text, "습        도 : " + ServerSocketAcceptIOT.getDbhelper().returnHumidity() + "%");
