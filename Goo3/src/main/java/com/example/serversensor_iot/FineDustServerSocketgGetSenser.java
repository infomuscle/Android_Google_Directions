...
public class FineDustServerSocketgGetSenser extends Thread {
    ...
    @Override
    public void run() {
        dbhelper = dbhelper = ((MainActivity) MainActivity.mContext).getDbhelper();
        ...
        try {
            ...
            while (true) {
                try
                {
                    ...
                    Log.e("결과 확인 FineDust 오류 while in : ", "");
                    Log.e("결과 확인 FineDust 오류 while in 1 : ", e.toString());
                    Log.e("결과 확인 FineDust 오류 while in 2 : ", e.getMessage());
        ...
        try {
            if (type_data != null && date_data != null && value_data != null) {
                ...
                if (type_data.equals("TEMP")) {
                    System.out.println("결과 확인 FineDust TEMP : " + value_data);
                    textView_Temperature.setText("온도 2 : " + value_data);

                } else if (type_data.equals("HUMI")) {
                    System.out.println("결과 확인 FineDust HUMI : " + value_data);
                    textView_Humidity.setText("습도 2 : " + value_data);
                }
            ...
            Log.e("결과 확인 FineDust dbinsert 오류 : ","");
            Log.e("결과 확인 FineDust dbinsert 오류 1 : ", e.toString());
            Log.e("결과 확인 FineDust dbinsert 오류 2 : ", e.getMessage());
